...
import Listu from "../../components/structure/Listu";
import "./style.css";
...
const Cadu = () => {
  ...
  const handleSubmit = async (evento) => {
    ...
    const request = await Apii.fetchPost(user);
        ...
        <div className="card-title">
          <div className="row">
            <div className="col">
              ...
              <h3 className="mx-3 my-3 text-center">Cadastro de Usuarios</h3>
            </div>
          </div>
        </div>
            ...
            <div className="row mb-3">
              <div className="col-5">
                <div className="form-group">
                  ...
                  <input id="name" className="form-control" type="text" placeholder="Nome do Produto" name="name"/>
                </div>
              </div>
              <div className="col-5">
                <div className="form-group">
