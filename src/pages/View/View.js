      ...
      <div className="row my-5">
        ...
        <div className="col-6">
          <div className="card my-10 bg-light">
            <h1 className="text-center my-2"><b>Nome: </b>{produto.titulo}</h1>
            <h3 className="text-center text-success "><b>Descrição: </b>{produto.descricao}</h3>
            <h4 className="text-center text-danger"><b>Prio: </b> {produto.prioridade}</h4>
            <h5 className="text-center text-primary"><b>Status: </b>{produto.status}</h5>
            <h5 className="text-center text-warning"><b>Data: </b>{produto.prazo}</h5>
